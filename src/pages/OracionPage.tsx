  ...
  return (
    <>
          ...
          <Accordion type="single" collapsible className="space-y-2">
            {prayers.map((prayer) => (
              <AccordionItem key={prayer.id} value={prayer.id}>
                ...
                <AccordionContent>
                  <p className="whitespace-pre-line font-serif text-xl italic leading-relaxed text-muted-foreground">
                    {prayer.text}
                  </p>
                </AccordionContent>
              </AccordionItem>
      ...
      <SectionContainer alt>
        ...
        <p className="mb-6 text-xl md:text-lg leading-relaxed text-muted-foreground">
          {t("novena.intro")}
        </p>
        <Card className="mb-6">
          <CardHeader>
          ...
          <CardContent>
            <p className="whitespace-pre-line font-serif text-xl md:text-lg italic leading-relaxed text-muted-foreground">
        ...
        <ol className="space-y-3">
          {novenaDays.map((day) => (
            <li key={day.day} className="flex items-baseline gap-3">
              ...
              <span className="text-xl md:text-lg text-foreground">
                {day.theme}
              </span>
            </li>
          ))}
          ...
          {quotes.map((quote, i) => (
            <motion.div key={i} variants={fadeUp} whileHover={hoverLift}>
              <div className="rounded-xl glass-subtle p-4 border-l-3 border-secondary/40">
                ...
                <p className="font-serif text-xl md:text-lg italic leading-relaxed text-foreground">
      ...
      <SectionContainer alt>
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="whitespace-pre-line text-center font-serif text-xl md:text-lg italic leading-relaxed text-foreground">
              {t("hymn.chorus")}
            </p>
          </CardContent>
        </Card>
