  ...
  return (
    <>
      ...
      <section className="bg-sky-mist">
        <div className="mx-auto max-w-5xl px-6 py-20 md:py-20">
          <motion.div
            ...
            className="space-y-4"
          >
            <h1 className="font-serif text-5xl font-bold text-foreground md:text-5xl">
              {t("hero.title")}
            </h1>
            <div className="h-[2px] w-16 rounded-full bg-gradient-to-r from-secondary/60 via-secondary to-secondary/60" />
            <p className="text-2xl md:text-xl leading-relaxed text-muted-foreground">
              {t("hero.subtitle")}
            </p>
          </motion.div>
        </div>
              ...
              <motion.div key={i} variants={fadeUp} whileHover={hoverLift}>
                <Card className="h-full">
                  <CardContent className="flex gap-4 pt-6">
                    ...
                    <div>
                      <h3 className="mb-1 text-xl md:text-lg font-semibold text-foreground">
                        {item.title}
                      </h3>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#2A4F7A] via-[#345f8f] to-[#3B6B9C] text-white">
        ...
        >
          <h2 className="font-serif text-4xl md:text-3xl font-bold">
            {t("donate.title")}
          </h2>
          <p className="mt-2 text-2xl md:text-xl text-white/80">{t("donate.heading")}</p>
          <p className="mt-4 text-xl md:text-lg text-white/70">{t("donate.body")}</p>
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2">
            <div>
              ...
              <ul className="space-y-2 text-xl md:text-lg text-white/80">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-xl md:text-lg text-white/80">
      ...
      <SectionContainer alt>
        ...
        <div className="mt-6 flex flex-col gap-6 md:flex-row md:items-center">
          <div className="space-y-1 text-xl md:text-lg text-foreground">
